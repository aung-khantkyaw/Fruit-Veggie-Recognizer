...
with st.sidebar:
    ...
    """)
    st.markdown("---")
    st.write("© 2025 Fruit & Veggie Recognizer. All rights reserved. Developed by **[laziestant](https://www.aungkhantkyaw.live/)**.")
    ...
    with st.spinner("Predicting..."):
        ...
        try:
            response = requests.post(
                ...
                headers={
                    "Authorization": "Bearer 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",
